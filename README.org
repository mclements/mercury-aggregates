...
| bag_median(Predicate, Result)             | set_media(Predicate, Result)           |
| bag_quantile(Predicate, Quantile, Result) | set_media(Predicate, Quantile, Result) |
| bag_cum_sum(Predicate(By,X), Result)      |                                        |
| bag_row_number(Predicate, Result)         |                                        |
